...
<div id="main">
    <c:if test="${empty user}">
        ...
        <div>&nbsp</div>
        <div>
            <h1 align="center"><a href="pages/user/login.jsp"
                                  style="text-decoration: none;color: red">亲，请先登录！！！</a>
            </h1>
        </div>
    </c:if>
    <c:if test="${not empty user}">
        <c:if test="${empty sessionScope.cart.items}">
            ...
            <div>&nbsp</div>
            <div>
                <h1 align="center"><a href="index.jsp"
                                      style="text-decoration: none;color: red">亲，当前购物车为空！快跟小伙伴们去浏览商品吧！！！</a>
                </h1>
            </div>
        </c:if>
            ...
            <table>
                ...
                <c:forEach items="${sessionScope.cart.items}" var="entry">
                    <tr>
                        ...
                        <td><input type="number" value="${entry.value.count}" min="1" max="20"
